...
@section('content')
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h3>Add Custom Field <a href="{{ route('forms.show', $id) }}"><button class="btn btn-primary">Back</button></a></h3>
          </div>
          <div class="col-sm-6">
    ...
    <section class="content">
      ...
      <div class="row">
        <div class="col-12">
          <a href="{{ route('forms.show', $id) }}" class="btn btn-secondary">Cancel</a>
