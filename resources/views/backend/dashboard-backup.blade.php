            ...
            <div class="card">
              <div class="card-header">
                ...
                <div class="card-tools">
                    <a id="viewWorkOrder" href="{{ route('equipment_issues.index') }}" class="btn btn-success btn-sm"><i class="fas fa-eye mx-2"></i> View more equipment issues</a>
                </div>
              </div><!-- /.card-header -->
              <div class="card-body">
            ...
            <div class="card">
              ...
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped mt-3">
                  ...
                  <tbody>
                    @if($workorders_list)
                    @foreach($workorders_list as $key => $work_order)
                  @php 
