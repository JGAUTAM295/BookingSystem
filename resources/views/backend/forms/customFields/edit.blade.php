...
@section('content')
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h3>Custom Field Detail <a href="{{ route('forms.show', $customFields->form_id) }}"><button class="btn btn-primary">Back</button></a></h3>
          </div>
          <div class="col-sm-6">
          ...
          <div class="card card-primary">
            ...
            <div class="card-body">
              <form action="{{ route('custom-fields.update', $customFields->id) }}" method="POST" enctype="multipart/form-data">
                @method('patch')
                @csrf
                <input type="hidden" name="form_id" value="{{$customFields->form_id ?? ''}}">
                <div class="row">
                  <div class="col-md-6">
                    ...
                    <div class="form-group {{ $errors->has('input_field_type') ? 'has-error' : ''}}">
                        ...
                        <select id="input_type" class="form-control custom-select" name="input_field_type">
                          ...
                          <option value="Date" @if($customFields->input_field_type == 'Date') selected @endif>DateTime</option>
                          ...
                          <option value="Email" @if($customFields->input_field_type == 'Email') selected @endif>Email</option>
                          <option value="Artist" @if($customFields->input_field_type == 'Artist') selected @endif>Artist</option>
                        </select>
                      ...
                      <div id="ArtistValid" class="form-group {{ $errors->has('input_artist') ? 'has-error' : ''}}" style="display:none">
                        <label for="input_artist">Artist Type</label>
                        <select id="input_artist" class="form-control custom-select" name="input_artist">
                  ...
                  <div class="col-12">
                    <a href="{{ route('forms.show', $customFields->form_id) }}" class="btn btn-secondary">Cancel</a>
